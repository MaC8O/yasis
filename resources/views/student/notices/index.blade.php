<x-app-layout title="Notices" subtitle="School notices visible to students." badge="Student view" role="student">
    <x-card>
        <div class="space-y-4">
            @forelse ($announcements as $announcement)
                <div class="border-b border-neutral-100 last:border-0 pb-4">
                    ...
                    <p class="text-xs text-neutral-400 mt-1">{{ $announcement->published_at->format('M j, Y') }}</p>
                </div>
            @empty
