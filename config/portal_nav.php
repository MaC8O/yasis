...
return [
    'admin' => [
        ...
        'items' => [
            ...
            ['label' => 'Academic Calendar', 'route' => 'admin.calendar.index'],
            ['label' => 'Grade Scale', 'route' => 'admin.grade-scale.index'],
            ['label' => 'Audit Logs', 'route' => 'admin.audit-logs.index'],
            ['label' => 'Data & Backup', 'route' => 'admin.backup.index'],
    ...
    'principal' => [
        ...
        'items' => [
            ...
            ['label' => 'Academic Calendar', 'route' => 'calendar.index'],
    ...
    'registrar' => [
        ...
        'items' => [
            ...
            ['label' => 'Academic Calendar', 'route' => 'registrar.calendar.index'],
        ],
    ],
    'teacher' => [
